...
struct TravelGuide{
    ...
    static var travelGuides =
        [
            ...
            TravelGuide(latitude: 40.835456, longitude: 14.2501048, name: "Nombre Apellido", description: "Hello there I would love to be your guide!. Im a student and a singer. I can give you any kind of tour you are trying to put together",location: "Interests: Art, history, music, Folklore, food in Naples", image: UIImage(named: "Janet")!),
